<?php
include_once("dbthucpham.php");
$thucpham = new thucPhamDAO();
$dsthucpham = $thucpham->getAllThucPham();
$dsdanhmuc = $thucpham->getAllDanhMuc();
?>
<!DOCTYPE html>
<html lang="en">
	...
	<section class="ftco-section">
		<div class="container">
			<?php if (isset($_GET['id'])) {
				$id = $_GET['id']; {
					foreach ($dsthucpham as $value) {
						if ($value['id_sanpham'] == $id) {

							?>
							<div class="row">
								<div class="col-lg-6 mb-5 ftco-animate">
									<a href="<?php echo $value['tenanh'] ?>" class="image-popup"><img src="<?php echo $value['tenanh'] ?>" class="img-fluid"
